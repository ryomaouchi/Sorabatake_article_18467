'''
This code is the modification of the following code:
https://github.com/t0nberryking/DCGAN256

Note that the code noted above is, in turn, the modification of 
manicman1999/GAN256

The full credit of the basic model structure design goes to 
manicman1999/GAN256


** Modifications **

1) Data loading part is modified to fit our case.

2) The function "eval2" is modified so that it saves each generated image (in addition to the concatenated images). 
...
Images = []
images_path = glob("./Data_oil_tank/data/*") # os.getcwd() + '\images'
...
for path in images_path:
    ...
    Images.append(np.flip(Images[-1], 0)) # ouchi
...
class Model_GAN(object):
    ...
    def eval2(self, num = 0):
        ...
        for i in range(48):
            ...
            im_gen.save("Generated_images/gen_"+str(num)+ "_" + str(i) + ".png")
